...
import com.olros.bussapp.R;
import com.olros.bussapp.Constants;
import com.olros.bussapp.Utils;
...
public class UtilityService extends IntentService {
    ...
    public static void requestLocation(Context context) {
        ...
        context.startService(intent);
        Log.v("Posisjon", "requestLocation");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (ACTION_ADD_GEOFENCES.equals(action)) {
            ...
            Log.v("Posisjon", "Action_request_location");
            ...
            String city = currentLocation == null ? "Kristiansand" : "Kristiansand";
    ...
    private void addGeofencesInternal() {
        ...
        /*if (connectionResult.isSuccess() && googleApiClient.isConnected()) {
            ...
            GeofencingApi.addGeofences(googleApiClient,
                    Model.getGeofenceList(), pendingIntent);
    ...
    public void requestLocationInternal() {
        ...
        Log.v("Posisjon", "requestLocationInternal");

        if (!Utils.checkFineLocationPermission(this)) {
            Log.v("Posisjon", "!utils");
            return;
        }
        ...
        if (connectionResult.isSuccess() && googleApiClient.isConnected()) {
            Log.v("Posisjon", "ConnectionSuccess");
    ...
    /*private void showNotification(String cityId, boolean microApp) {
        ...
        ArrayList<Model> attractions = holdeplasser.get(cityId);
        ...
        Model attraction = attractions.get(0);
...
/*
     ...
     */
    /*
    private void sendDataToWearable(List<Model> attractions) {
        GoogleApiClient googleApiClient = new GoogleApiClient.Builder(this)
                .addApi(Wearable.API)
                .build();
